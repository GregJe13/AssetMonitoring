...
@section('content')
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">Manage active rental agreements, track expirations, and monitor payment
                schedules.</p>
        </div>
    ...
    <div class="mt-8 flow-root" id="tabContainer" x-data="{ activeTab: '{{ $tab }}' }">
        ...
        <div x-show="activeTab === 'active'" x-transition:enter="transition ease-out duration-200"
                            ...
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Tenant
                                        & Reference</th>
                                    <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Assets
                                    </th>
